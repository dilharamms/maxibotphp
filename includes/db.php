<?php
// Maxibot SQLite Database Connection & Initialization Helper

$db_dir = dirname(__DIR__) . '/data';
$db_path = $db_dir . '/maxibot.db';
...
try {
    ...
    if ($prod_check == 0) {
        // Direct seed array based on original db data
        require_once __DIR__ . '/products-db.php';
        // We will read the static products array before we make it dynamic
        // Note: we can define the seed array explicitly here to make it safe
        $default_products = [
            [
